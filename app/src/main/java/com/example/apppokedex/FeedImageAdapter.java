...
public class FeedImageAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.tvNewArtist.setText(currentApp.getNum());

       // viewHolder.tvData.setText(currentApp.getType());

        new DownloadImageTask(viewHolder.ivImageApp).execute(currentApp.getImg());
